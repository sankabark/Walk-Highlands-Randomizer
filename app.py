...
st.set_page_config(
    page_title="WalkHighlands Randomizer",
    page_icon="🥾",
    layout="centered"
)
...
st.caption(":red[All walk information was gathered by hand from the walkhighlands website, there me be errors in start coordinates or web addresses. Please double check with the walkhighlands website before starting your journey. Always have the appropriate gear for the season and the hike you're undertaking. If you find any issues with the tool please send an email to connorgowbusiness@gmail.com]")
